...
public class KWSymptomPage implements ActionListener {
...
/*     private JLabel chapter = new JLabel("Chapter :");
    private JLabel subchapter = new JLabel("Subchapter :"); */
    ...
    private List<ClassifiedSymptom> results = new ArrayList<>();

    private Font fontStyle=new Font("Monospaced Bold Italic",Font.BOLD,25);
    private GridBagConstraints a = new GridBagConstraints();
    private static String CLASSIFY_SYMPTOM_API_URL = "http://dagere.comiles.eu:8090/keyword/classifySymptom/";
    private static String[] myInput;
    public KWSymptomPage() {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==next){
            a.gridy=3;
            String unknown = "<html><br/>0 ( 0 )</html>";
            ...
            try
            {
                ...
                {
                    menuPanel.remove(databaseRetrieved);
                    databaseRetrieved.setText("no classification");
                    databaseRetrieved.setFont(fontStyle);
                    menuPanel.add(databaseRetrieved,a);
                    System.out.println(databaseRetrieved.getText());
            ...
            CLASSIFY_SYMPTOM_API_URL = "http://dagere.comiles.eu:8090/keyword/classifySymptom/";
        }
    }
